...
export const purchasePrizeForFan = async (request: PrizePurchaseRequest): Promise<void> => {
  try {
...
export const fanIdMatchesToken = async (fanPartial: Partial<Fan>): Promise<boolean> => {
